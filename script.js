//API Key - a7b124b2
//Example - http://www.omdbapi.com/?i=tt3896198&apikey=a7b124b2
...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=a7b124b2')
    .then(res => res.json())
...
async function singleMovie() {
    ...
    <div class="movie-details">
        ...
        <p style="font-size: 14px; color="white"; margin-top:10px;">${data.Plot}</p>
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div style="color: #f5310a">
                        <i class="fa-solid fa-trash" style="cursor:pointer;
                 " onClick=removeFromfavorites('${Id}')></i>
                    </div>
                </div>
            </div>
        </div>
